...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- font CSS -->
    <link href='admin_style///fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
    <!-- font-awesome icons -->
    ...
    <script src="admin_style/js/raphael-min.js"></script>
    <script src="admin_style/js/morris.js"></script>
</head>
<body>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="admin_style/images/admin.png">
                        <span class="username">
                            <?php
    ...
    <section id="main-content">
        ...
        <div class="footer">
            <div class="wthree-copyright">
                <p>© 2019 HaNoi | Design by <a href="http://w3layouts.com">W3layouts</a></p>
            </div>
        </div>
        <!-- / footer -->
    </section>
...
<!-- calendar -->
<script type="text/javascript" src="admin_style/js/monthly.js"></script>
